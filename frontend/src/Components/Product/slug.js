...
const Slug = ({ cart, addToCart, removeFormCart, subTotal, clearCart }) => {
  ...
  const size = urlParams.get("size").split(",");
    ...
    <section className="text-gray-600 body-font   mb-[30px]  overflow-hidden">
      <div className="container px-5 py-10   mx-auto">
        <div className="lg:w-4/5 mx-auto flex flex-wrap">
          <img alt="ecommerce" className="lg:w-1/2 w-full lg:h-auto  px-10 md:px-24  object-cover object-top rounded" src={`../${urlParams.get('i')}`} />
          <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
            ...
            <div className="flex mt-6 items-center pb-5 border-b-2 border-gray-100 mb-5">
              <div className="flex">
                ...
                {colors.map((e,i) => {
                  return <button key={i} className={`border-2 border-gray-300 ml-1 bg-${e}${e=="black"?"":"-500"} rounded-full w-6 h-6 focus:outline-none`}></button>
              ...
              <div className="flex ml-6 items-center">
                ...
                <div className="relative">
                  <select className="rounded border appearance-none border-gray-300 py-2 focus:outline-none focus:ring-2 focus:ring-blue-200 focus:border-blue-500 text-base pl-3 pr-10">
                    {size.includes("S") ? <option>S</option> : ""}
                    {size.includes("SM") ? <option>SM</option> : ""}
                    {size.includes("M") ? <option>M</option> : ""}
                    {size.includes("XL") ? <option>XL</option> : ""}
                    {size.includes("L") ? <option>L</option> : ""}
                    {size.includes("XLL") ? <option>XLL</option> : ""}
            ...
            <div className="flex  items-center">
              <span className="title-font font-medium text-2xl text-gray-900"><i className="bi bi-currency-rupee"></i>{urlParams.get("price")}</span>
