...
const Slug = () => {
  return (
    <section class="text-gray-600 body-font  mt-[50px] mb-[30px]  overflow-hidden">
  <div class="container px-5 py-20 mx-auto">
    <div class="lg:w-4/5 mx-auto flex flex-wrap">
      <img alt="ecommerce" class="lg:w-1/2 w-full lg:h-auto px-10 md:px-24  object-cover object-top rounded" src="https://images.meesho.com/images/products/354322639/n02yn_400.webp"/>
      <div class="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
        ...
        <div class="flex">
          <span class="title-font font-medium text-2xl text-gray-900"><i className="bi bi-currency-rupee"></i>499</span>
